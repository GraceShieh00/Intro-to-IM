...
//displays ten bubbles, each scaled according to the value they display
//when the mouse is clicked, creates a new bubble according to the x and y location of the bubble
//if hold the mouse, the random colors will fill the specific bubble the mouse just clicked on
